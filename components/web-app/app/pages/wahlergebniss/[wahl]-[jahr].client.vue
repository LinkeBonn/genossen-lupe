    ...
    <div class="content">
      <ClientOnly fallback="Map Loading...">
        <PollMap
          :poll="poll"
          :votes="votes"
          @on-vote-change="geodata.onVoteChange"
          @on-area-change="geodata.onAreaChange"
        />
      </ClientOnly>
...
import PollMap from "~/components/PollMap.vue";
...
const votes = computed(() =>
  route.params.wahl === "europawahl"
    ? ["Europawahl"]
    : route.params.wahl === "kommunalwahl"
      ? ["Ratswahl"]
